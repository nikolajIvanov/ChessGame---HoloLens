...
public class H_Pawn : H_Piece
{
    public override List<Vector2Int> SelectAvaliableSquares()
    {
        avaliableMoves.Clear();

        Vector2Int direction = team == H_TeamColor.White ? Vector2Int.up : Vector2Int.down;
    ...
    {
        int endOfBoardYCoord = team == H_TeamColor.White ? H_Board.BOARD_SIZE - 1 : 0;
